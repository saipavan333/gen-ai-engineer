window.CURRICULUM = {
  ...
  sections: [
    ...
    {
      id: "t9", num: "9", title: "Interview Bank", ready: true,
      blurb: "What GenAI teams actually ask this year, with model answers and the reasoning behind each one.",
      lessons: [
        { n: "9.1", title: "Foundations Q&A", file: "track9/01-foundations-qa.html", built: true },
        { n: "9.2", title: "RAG Q&A", file: "track9/02-rag-qa.html", built: true },
        { n: "9.3", title: "Agents Q&A", file: "track9/03-agents-qa.html", built: true },
        { n: "9.4", title: "System design rounds", file: "track9/04-system-design.html", built: true },
        { n: "9.5", title: "Take-home patterns", file: "track9/05-take-home-patterns.html", built: true },
        { n: "9.6", title: "Behavioral & judgment", file: "track9/06-behavioral-judgment.html", built: true }
      ]
    },
    {
      id: "t10", num: "10", title: "Capstones", ready: true,
      blurb: "End-to-end products that actually run — the portfolio that proves you can ship.",
      lessons: [
        { n: "10.1", title: "RAG assistant over your docs", file: "track10/01-rag-assistant.html", built: true },
        { n: "10.2", title: "A tool-using agent", file: "track10/02-tool-using-agent.html", built: true },
        { n: "10.3", title: "A prompt/RAG eval harness", file: "track10/03-eval-harness.html", built: true },
        { n: "10.4", title: "A fine-tuned domain model", file: "track10/04-finetuned-model.html", built: true },
        { n: "10.5", title: "A cost & latency-optimized chat service", file: "track10/05-optimized-chat-service.html", built: true }
      ]
    },
    {
      id: "t11", num: "11", title: "Get Hired", ready: true,
    ...
    {
      id: "t12", num: "12", title: "Going Deeper", ready: true,
    ...
    {
      id: "t13", num: "13", title: "Structured Data & Text-to-SQL", ready: true,
      ...
      lessons: [
        { n: "13.1", title: "Why text-to-SQL (and where it breaks)", file: "track13/01-why-text-to-sql.html", built: true },
    ...
    {
      id: "t14", num: "14", title: "Productionization & LLMOps", ready: true,
      blurb: "Ship it: wrap your app in a service, containerize it, gate changes with evals, and monitor it in production.",
      lessons: [
        { n: "14.1", title: "From notebook to a service", file: "track14/01-notebook-to-service.html", built: true },
    ...
    {
      id: "t15", num: "15", title: "Multimodal AI", ready: true,
      blurb: "Give your systems eyes and ears: vision-language models, document AI, audio, and multimodal RAG.",
      lessons: [
        { n: "15.1", title: "Beyond text: vision-language models", file: "track15/01-vision-language-models.html", built: true },
    ...
    {
      id: "t16", num: "16", title: "Frontier & Responsible AI", ready: true,
      blurb: "Where the field is heading and how to build responsibly: reasoning models, the frontier, bias, and regulation.",
      lessons: [
        { n: "16.1", title: "Reasoning models & test-time compute", file: "track16/01-reasoning-models.html", built: true },
